        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StopLong = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StopTrips", x => new { x.TripId, x.StopSequence });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StopTrips_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StopTrips_StopId",
                table: "StopTrips",
                column: "StopId");

            migrationBuilder.CreateIndex(
                name: "IX_StopTrips_TripId_StopId",
                table: "StopTrips",
